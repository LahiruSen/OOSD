...
if ( $_SESSION['logged_in'] != 1 ) {
    ...
    if($types == 1)
    {
        header("location: submit_scholarship_application.php");
    }
...
<?php } else { ?>
    ...
    <!--content-->
            <form action="scholarship_upload_success.php" method="post" enctype="multipart/form-data">
                First Name              :<br>
                <input type="text" name="first_name1">
                <br>
                Registration Number     :<br>
                <input type="text" name = "registration_number1">
                <br>
