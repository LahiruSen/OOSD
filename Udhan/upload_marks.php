...
<section class="" id="portfolio">
    <div class="container ">
        ...
        <div class="text-center text-secondary mb-0">
            <li class="badge"><label  class="text-center text-success mb-0">Marks successfully updated for</label></li><br>
            <li class="badge"><label  class="text-center text-success mb-0">Registration Number : <?php echo $reg_no ?></label></li>
        </div>
