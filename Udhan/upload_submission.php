    ...
    <div class="container ">
        ...
        if($name==''){
            ...
            <div class="text-center text-secondary mb-0">
                <li class="badge"><label  class="text-center text-danger mb-0">Your Submission is unsuccessful ! Please try again</label>
            </div>
            <?php
        }else{
            $mysqli->query("INSERT INTO assignment_submissions(assignment_id, student_id, pdf_link) VALUES ('$assignment_id','$reg_no','$string')");
        ...
        ?>
        <div class="text-center text-secondary mb-0">
            <br><li class="badge"><a href="view_assignments_student.php"><input class="btn btn-secondary btn-lg" style="height:55px;" type="button" value="BACK"/></a></li>
        </div>
