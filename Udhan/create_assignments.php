            ...
            <div class="col-lg-6 ">
                ...
                <form action="upload_assignment.php" method="POST" enctype="multipart/form-data">
                    <div class="field-wrap">
                        <li class="badge"><label  class="btn btn-light btn-lg-0">Title</label>
                            <input  class="btn btn-success btn-lg-0" type="text" required autocomplete="off" name="title"/></li>
                    </div>


                    <div class="field-wrap">
                        <li class="badge"><label  class="btn btn-light btn-lg">Description</label>
                            <input  class="btn btn-success btn-lg-0" type="text" required autocomplete="off" name="description"/></li>
                    </div>


                    <div class="field-wrap">
                        <li class="badge"><label  class="btn btn-light btn-lg">Attachment</label>
                            <input class="btn btn-success btn-lg-0" type="file" name="file"/></li>
                    </div>

                    <div class="field-wrap">
                        <li class="badge"><label  class="btn btn-light btn-lg">Deadline</label>
                            <input  class="btn btn-success btn-lg-0" type="date" required autocomplete="off" name="deadline"/></li>
                    </div>

                    <div class="field-wrap">
                        <li class="badge"><input class="btn btn-primary btn-lg" type="submit" value="Submit"></li>
                    </div>
                </form>
